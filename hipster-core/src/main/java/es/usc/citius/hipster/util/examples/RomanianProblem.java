...
public class RomanianProblem {
    ...
    public enum City{
        ...
        HIRSOVA, IASI, LUGOJ, MEHADIA, NEAMT, ORADEA, PITEST, RIMNICU_VILCEA,
    ...
    static {
        ...
        heuristicMap.put(City.PITEST, 100d);
        ...
        graph = GraphBuilder.<City,Double>create()
                ...
                .connect(City.PITEST).to(City.RIMNICU_VILCEA).withEdge(97d)
